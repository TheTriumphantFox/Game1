...
// The late-tower Shadow Step vault is GONE, along with the ability that opened
// it. It was a large chest sealed inside two tiles of wall on floors 12 and up,
// stamped after towerSealUnreachable so that pass could not fill it in — the one
// thing in the tower that could only be reached by phasing through masonry.
// Shadow armor grants the Umbral Veil now instead of Shadow Step (elements.js),
// so nothing in the game steps through walls and the vault would be a chest the
// player can see from the corridor and never open.
