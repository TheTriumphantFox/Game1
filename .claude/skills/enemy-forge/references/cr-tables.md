...
Derived from the D&D 5e monster-creation guidelines. Use these as the *baseline* to scale from — see the calibration step in SKILL.md. These assume tabletop party-of-four combat, which Hero of Stormdrift is not.
...
Then apply the project's HP scaling ratio before writing the actual stat block — the 80 HP above is a tabletop figure, not a Hero of Stormdrift figure.
