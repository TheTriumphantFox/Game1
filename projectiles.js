...
const TROPHY_META = {
  ...
  // ── Per-enemy signature trophies ──────────────────────────────────────────
  // One unique drop per enemy so no two enemies share a trophy (see ENEMY_DROPS
  // in player.js). The trophies above are each kept by a single "first" enemy
  // of their old shared group; everything below is its enemy's own spoil.
  dryad_bloom:       { icon: '🌷', label: 'Dryad Bloom',        color: '#d98fb0' },
  gnoll_fang:        { icon: '🦷', label: 'Gnoll Fang',         color: '#d9c9a0' },
  hound_fang:        { icon: '🦷', label: 'Hellhound Fang',     color: '#cc5522' },
  salamander_hide:   { icon: '🦎', label: 'Salamander Hide',    color: '#ff5a2a' },
  kuotoa_gill:       { icon: '🐠', label: 'Kuo-toa Gill',       color: '#79b08a' },
  shark_tooth:       { icon: '🦈', label: 'Shark Tooth',        color: '#9bb6c8' },
  hag_hair:          { icon: '🧶', label: 'Sea Hag Hair',       color: '#5e7d63' },
  frost_fang:        { icon: '❄️', label: 'Frost Fang',         color: '#cce6ff' },
  rime:              { icon: '🧊', label: 'Rime Crystal',       color: '#bfe0ff' },
  acid_gland:        { icon: '🧪', label: 'Acid Gland',         color: '#aacc33' },
  displacer_hide:    { icon: '🐆', label: 'Displacer Hide',     color: '#4a3a6a' },
  bulette_plate:     { icon: '🛡️', label: 'Bulette Plate',      color: '#6a7a5a' },
  earth_heart:       { icon: '🟤', label: 'Earthen Heart',      color: '#8a6a4a' },
  granite:           { icon: '🗿', label: 'Granite Slab',       color: '#8a857a' },
  harpy_plume:       { icon: '🪶', label: 'Harpy Plume',        color: '#b59ad6' },
  griffon_feather:   { icon: '🦅', label: 'Griffon Feather',    color: '#c8a45a' },
  manticore_spike:   { icon: '🗡️', label: 'Manticore Spike',    color: '#aa4433' },
  zephyr:            { icon: '🌀', label: 'Zephyr Wisp',        color: '#cfe8ff' },
  wyvern_scale:      { icon: '🐲', label: 'Wyvern Scale',       color: '#6a8a4a' },
  roc_plume:         { icon: '🪶', label: 'Roc Plume',          color: '#b0855a' },
  wyrmling_scale:    { icon: '🐉', label: 'Wyrmling Scale',     color: '#4477cc' },
  behir_scale:       { icon: '🐍', label: 'Behir Scale',        color: '#4488cc' },
  bluedragon_scale:  { icon: '🐉', label: 'Blue Dragon Scale',  color: '#3366cc' },
  stormgiant_bolt:   { icon: '🌩️', label: 'Tempest Bolt',       color: '#ffe066' },
  pegasus_feather:   { icon: '🪽', label: 'Pegasus Feather',    color: '#eaf2ff' },
  couatl_scale:      { icon: '🌈', label: 'Couatl Scale',       color: '#66ccaa' },
  kirin_horn:        { icon: '🦌', label: 'Ki-rin Horn',        color: '#ffe6aa' },
  planetar_halo:     { icon: '😇', label: 'Planetar Halo',      color: '#fff0b0' },
  wraith_shroud:     { icon: '🧣', label: 'Wraith Shroud',      color: '#556677' },
  vampire_fang:      { icon: '🧛', label: 'Vampire Fang',       color: '#aa2233' },
  phylactery:        { icon: '🔮', label: 'Phylactery',         color: '#66ddaa' },
  crawler_venom:     { icon: '🐛', label: 'Carrion Bile',       color: '#99bb44' },
  troll_hide:        { icon: '🟢', label: 'Troll Hide',         color: '#6a8a4a' },
  otyugh_tentacle:   { icon: '🦑', label: 'Otyugh Tentacle',    color: '#88aa55' },
  treant_heartwood:  { icon: '🪵', label: 'Heartwood',          color: '#8a6a3a' },
  greendragon_scale: { icon: '🐉', label: 'Green Dragon Scale', color: '#44aa55' },
  worm_stinger:      { icon: '🪱', label: 'Worm Stinger',       color: '#aa66aa' },
  horror_plate:      { icon: '🛡️', label: 'Animus Plate',       color: '#8899aa' },
  gith_blade:        { icon: '⚔️', label: 'Githyanki Blade',    color: '#b0c0d0' },
  eyestalk:          { icon: '👁️', label: 'Eyestalk',           color: '#cc66bb' },
  rakshasa_claw:     { icon: '🐾', label: 'Rakshasa Claw',      color: '#cc8844' },
