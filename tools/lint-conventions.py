#!/usr/bin/env python3
"""
lint-conventions.py — convention checker for Hero of Stormdrift.
...
# NOTE: there is deliberately no "registration" check in this linter. Hero of
# Stormdrift has no registerEntity()/registerTile()-style API to check for — `world.js`'s
...
# itself, map/level data, and anything explicitly authored as data. Hero of
# Stormdrift has no separate mapdata/levels/spawns files — world placement is
